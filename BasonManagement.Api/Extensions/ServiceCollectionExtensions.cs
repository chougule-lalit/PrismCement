using BasonManagement.Api.Services;
using BasonManagement.Application.DTOs.Settings;
using BasonManagement.Application.Interfaces;
...
using BasonManagement.Infrastructure.Identity.Services;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        private static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                c.IncludeXmlComments(string.Format(@"{0}\BasonManagement.Api.xml", System.AppDomain.CurrentDomain.BaseDirectory));
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Version = "v1",
                    Title = "BasonManagement",
